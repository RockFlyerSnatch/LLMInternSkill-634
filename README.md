...
```bash
git clone https://github.com/RockFlyerSnatch/LLMInternSkill-634.git
cd LLMInternSkill-634
python setup.py
```
...
git clone https://github.com/RockFlyerSnatch/LLMInternSkill-634 ~/.codex/skills/llm-intern-skill
```
...
<!-- Last updated: 2026-06-06 18:42:57 -->
